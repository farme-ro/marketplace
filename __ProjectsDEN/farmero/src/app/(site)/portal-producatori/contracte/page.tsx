/**
 * Producer Contracts Page
 * 
 * Pagină pentru vizualizarea contractelor producătorului
 */
...
import { getMyContracts, getContractById } from '@/lib/api/farmero-contracts'
              ...
              <table className="w-full">
                ...
                <tbody>
                  {contracts.map((contract) => (
                    <tr key={contract.id} className="border-b border-border/60 hover:bg-muted/30">
                      ...
                      <td className="py-4 px-4 text-right">
                        <Link href={`/portal-producatori/contracte/${contract.id}`}>
