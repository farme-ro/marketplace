/**
 * Importers Register Page
 * 
 * Pagină de înregistrare pentru importatori cu design tabbed-stepped
 */
...
function ImportersRegisterContent() {
  const router = useRouter()
  const searchParams = useSearchParams()
  const { registerImporter, isLoading } = useAuth()
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await registerImporter({
        ...
        importVolume: importVolume || undefined,
                    ...
                    <CardHeader className="text-center pb-6 px-0">
                      ...
                      >
                        <CardTitle className="text-2xl md:text-3xl font-semibold tracking-tight text-foreground mb-2">
                          {isSuccess ? 'Înregistrare reușită!' : 'Creează cont importator'}
                        </CardTitle>
                        <div className="w-16 h-1 bg-gradient-to-r from-primary via-primary to-primary rounded-full mb-4 mx-auto" />
                        <CardDescription className="text-sm text-muted-foreground">
                          {isSuccess ? 'Contul tău a fost creat cu succes' : 'Înregistrează-te pentru a accesa produse românești premium'}
                        </CardDescription>
                      </motion.div>
                    </CardHeader>
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            ...
                            <p className="text-muted-foreground max-w-md mx-auto">
                              Contul tău de importator a fost creat cu succes. Echipa noastră te va contacta în cel mult 24-48 de ore pentru aprobare.
                            </p>
                          </div>
                          <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/pentru-importatori/login">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                          ...
                          {currentStep === 2 && (
                            <motion.div
                              ...
                              className="space-y-5"
                            >
                              <h3 className="text-lg font-semibold text-foreground mb-4">Informații despre companie</h3>
                              <motion.div
                                initial={{ opacity: 0, y: 10 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 0.3 }}
                              ...
                              >
                                ...
                                <Input
                                  ...
                                  placeholder="Țara din care importi"
                                  disabled={isLoading}
                                  className="w-full"
                                />
                              </motion.div>
                              <motion.div
                                ...
                                className="space-y-2"
                              >
                                <label htmlFor="importVolume" className="block text-sm font-medium text-foreground">
                                  Volum estimat import
                                </label>
                                <Input
                                  id="importVolume"
                                  type="text"
                              ...
                              >
                                ...
                                <Textarea
                                  ...
                                  placeholder="Spune-ne mai multe despre interesul tău de import..."
                                  disabled={isLoading}
                  ...
                  >
                    <div className="text-center mb-8">
                      ...
                      <p className="text-base text-muted-foreground leading-relaxed mb-6 max-w-2xl mx-auto">
                        Accesează produse românești premium pentru export și construiește parteneriate strategice cu producători locali.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4 max-w-2xl mx-auto">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Produse românești premium</h3>
                          <p className="text-sm text-muted-foreground">Calitate verificată și certificată pentru export</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Parteneriate strategice</h3>
                          <p className="text-sm text-muted-foreground">Colaborări pe termen lung cu producători verificați</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Logistică internațională</h3>
                          <p className="text-sm text-muted-foreground">Soluții eficiente pentru livrări în UE și dincolo</p>
                        </div>
                      </div>
...
export default function ImportersRegisterPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-background" />}>
      <ImportersRegisterContent />
    </Suspense>
  )
}
