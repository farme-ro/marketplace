 ...
 * 
 * Hero section pentru pagina "Pentru Logistică și Transport"
 */
      ...
      <PageContainer className="relative z-10">
        ...
        >
          ...
          >
            ...
            {t('logistics.hero.badge', 'Colaboratori logistică și transport')}
          </motion.div>
          ...
          >
            {t('logistics.hero.title', 'Devino partener în')}{' '}
            <span className="text-primary">{t('logistics.hero.titleHighlight', 'logistica farme.ro')}</span>
          </motion.h1>
          ...
          >
            {t('logistics.hero.description', 'Colaborează cu noi pentru livrări cu mașini frigorifice, depozitare și pachetomate. Oportunități de parteneriat pentru companii de logistică.')}
          </motion.p>
          ...
          >
            <Link href="/pentru-logistica/register">
              ...
              >
                {t('logistics.hero.ctaPrimary', 'Devino partener logistică')}
            ...
            <Link href="#servicii">
              ...
              >
                {t('logistics.hero.ctaSecondary', 'Află mai multe')}
              </Button>
            </Link>
          </motion.div>
        </motion.div>
