/**
 * Importers CTA Section
 * 
 * Secțiunea finală cu call-to-action pentru importatori
 */
...
export function ImportersCTASection() {
  const { t } = useI18n()
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-background">
      {/* Anchor for market-opportunities */}
      <div id="market-opportunities" className="scroll-mt-20" />
      <PageContainer>
        <motion.div
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 text-center">
              ...
              >
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-foreground">
                  {t('importers.cta.title', 'Importă produse românești premium')}
                </h2>

                <p className="text-base md:text-lg text-foreground-body max-w-2xl mx-auto">
                  {t('importers.cta.description', 'Dacă ești importator și cauți produse agricole de calitate din România, suntem aici să te conectăm cu producătorii potriviți.')}
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                  <Link href="/pentru-importatori/register">
                    ...
                    >
                      ...
                      {t('importers.cta.button', 'Aplică acum')}
                    </Button>
                  </Link>
                  <a
                    href="mailto:importatori@farme.ro"
                  ...
                  >
                    ...
                    importatori@farme.ro
                  </a>
                </div>

                <p className="text-xs text-muted-foreground pt-4">
                  {t('importers.cta.responseTime', 'Răspundem la toate solicitările în maximum 24 de ore.')}
                </p>
              </motion.div>
            </CardContent>
          </Card>
