 ...
 * 
 * Pagină de înregistrare pentru conturi B2B cu design tabbed-stepped
 */
...
export default function BusinessRegisterPage() {
  ...
  const { registerBusiness, isLoading } = useAuth()
  ...
  const [businessType, setBusinessType] = useState<'HORECA' | 'RETAIL' | 'CORPORATE' | 'OTHER'>('HORECA')
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Map businessType to companyType
      let companyType: 'RESTAURANT' | 'HOTEL' | 'CAFE' | 'CATERING' | 'RETAIL' | 'OTHER' | undefined
      if (businessType === 'HORECA') {
        companyType = 'RESTAURANT' // Default for HORECA
      } else if (businessType === 'CORPORATE') {
        companyType = 'OTHER' // Map CORPORATE to OTHER
      } else {
        companyType = businessType as 'RETAIL' | 'OTHER'
      }
      ...
      await registerBusiness({
        ...
        companyName,
        companyType,
        registrationNumber: taxId || undefined,
                    ...
                    <CardHeader className="text-center pb-6 px-0">
                      ...
                      >
                        <CardTitle className="text-2xl md:text-3xl font-semibold tracking-tight text-foreground mb-2">
                          {isSuccess ? 'Înregistrare reușită!' : 'Creează cont B2B'}
                        </CardTitle>
                        <div className="w-16 h-1 bg-gradient-to-r from-primary via-primary to-primary rounded-full mb-4 mx-auto" />
                        <CardDescription className="text-sm text-muted-foreground">
                          {isSuccess ? 'Contul tău a fost creat cu succes' : 'Înregistrează-te pentru a beneficia de prețuri speciale B2B'}
                        </CardDescription>
                      </motion.div>
                    </CardHeader>
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            ...
                            <p className="text-muted-foreground max-w-md mx-auto">
                              Contul tău B2B a fost creat cu succes. Echipa noastră te va contacta în cel mult 24-48 de ore pentru aprobare.
                            </p>
                          </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                          ...
                          {currentStep === 2 && (
                            <motion.div
                              ...
                              className="space-y-5"
                            >
                              <h3 className="text-lg font-semibold text-foreground mb-4">Informații despre afacere</h3>
                              <motion.div
                                initial={{ opacity: 0, y: 10 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 0.3 }}
                              ...
                              >
                                ...
                                <Select
                                  ...
                                  className="w-full"
                                >
                                  <option value="HORECA">HoReCa (Restaurante, Hoteluri, Cafenele)</option>
                  ...
                  >
                    <div className="text-center mb-8">
                      ...
                      <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-foreground mb-3">
                        Devino partener B2B pe farme.ro
                      </h2>
                      ...
                      <p className="text-base text-muted-foreground leading-relaxed mb-6 max-w-2xl mx-auto">
                        Cumpără direct de la producători locali și beneficiază de prețuri speciale pentru afaceri.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4 max-w-2xl mx-auto">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Prețuri speciale B2B</h3>
                          <p className="text-sm text-muted-foreground">Beneficiază de reduceri pentru cantități mari</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Livrări programate</h3>
                          <p className="text-sm text-muted-foreground">Planifică livrările în funcție de nevoile tale</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Coșuri pentru angajați</h3>
                          <p className="text-sm text-muted-foreground">Gestionează coșuri personalizate pentru echipa ta</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-foreground mb-1">Facturare profesională</h3>
                          <p className="text-sm text-muted-foreground">Soluții complete de facturare și contracte</p>
                        </div>
                      </div>
                    </div>
