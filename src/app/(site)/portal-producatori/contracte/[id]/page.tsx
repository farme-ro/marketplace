/**
 * Producer Contract Details Page
 * 
...
export default function ProducerContractDetailsPage() {
        ...
        <Card className="border border-border rounded-2xl shadow-sm bg-card">
          <CardContent className="p-6">
            <div className="text-center py-12">
              ...
              <Link href="/portal-producatori/contracte">
                  ...
                  <div className="space-y-2">
                    {contract.parties.map((party, index) => (
                      <div key={party.id} className="flex items-center gap-2">
                        ...
                        {party.vatId && (
                          <span className="text-xs text-muted-foreground">(CUI: {party.vatId})</span>
                        )}
                      </div>
                    ))}
                  </div>
